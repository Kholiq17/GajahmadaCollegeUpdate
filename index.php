<?php include 'database/config.php'; $ambilportfolio = mysqli_query($koneksi, "SELECT * FROM `gallery`");
$ambilalumni = mysqli_query($koneksi,"SELECT * FROM alumni");
$ambilservis = mysqli_query($koneksi,"SELECT * FROM servis");
// PAGINATION
	$limit = 3;
...
<body id="home" class="scrollspy">
      ...
      <nav class="navbarku">
        <div class="container">
          <div class="nav-wrapper">
            <a href="#home">
            <img class="logo-top" src="assets/img/logo/1.png"></a>
    ...
    <section id="about" class="about scrollspy">
      <div class="container">
        <div class="center logo"></div>
          <div class="row isi">
            <div class="about col m7 light" data-aos="fade-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
            	<center><h5>We Are Professionals</h5></center>
            ...
            <div class="angka col m4 light" style="float: right;" data-aos="fade-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
              <p>DESAIN GRAFIS</p>
              <div class="progress">
    ...
    <!-- Info -->
    <div id="info" data-aos="fade-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
    	<section class="info scrollspy">
        <div class="container">
          <div class="row">
            <h3 class="center light black-text text-darken-3"> <i class="material-icons">bookmark</i> Info</h3>
						<?php if (0 != mysqli_num_rows($ambil)) {
    ...
    <div id="clients" class="parallax-container scrollspy">
      <span>
        <h3 class="center light white-text">Partner Kita</h3>
      </span>
      <div class="parallax"><img src="assets/img/slider/1.png"></div>
      <div class="dalem">
        <div class="container clients ">
          <div class="row">
            <div class="col m4 s12 center" data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
              <img src="assets/img/clients/pendidikan.png">
            </div>
            <div class="col m4 s12 center dinas" data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
              <img src="assets/img/clients/lsp.png">
            </div>
            <div class="col m4 s12 center hipki" data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
    ...
    <section id="services" class="services white lighten-3 scrollspy">
      <div class="container">
          ...
          <hr class="garis1">
          <?php foreach ($ambilservis as $ambil) {?>
          <div class="col s4">
            <div class="row">
              <div class="col s12 m12">
                <div class="card">
                  <div class="card-image">
                    <img src="assets/img/fotoservis/<?= $ambil['foto'] ?>" alt="" class="circle responsive-img" >
                  </div>
                  <div class="card-action">
                    <span class="card-title">Card Title</span>
                  </div>
                  <div class="card-content">
                    <p><?php echo $ambil['info'] ?>'</p>
                  </div>     
                </div>
              </div>
            </div>
    ...
    <!-- alumni -->
    <section id="alumni" class="alumni scrollspy">
      <div class="container">
        <div class="row">
          <h3 class="light grey-text text-darken-3 center">Alumni</h3>
          <hr class="garis1">
          <center>    
          <div class="slider1">
            <ul class="slides">
              <?php foreach ($ambilalumni as $ambil) {?>
              <li>               
              <div class="row">
                <div class="col s12 m12">
                  <div class="card">
                    <div class="card-image">
                      <img src="assets/img/fotoalumni/<?= $ambil['foto'] ?>" class="circle responsive-img">                
                    </div>
                    <div class="card-content">
                      <h3 class="center black-text"> <?php echo $ambil['nama']?> </h3>
                      <h5 class="grey-text ">Alamat : <?php echo $ambil['alamat']?></h5>
                      <h5 class="grey-text ">Angkatan : <?php echo $ambil['angkatan']?></h5>
                      <h5 class="grey-text ">Jurusan :<?php echo $ambil['jurusan']?></h5>
                      <h5 class="grey-text ">Pekerjaan : <?php echo $ambil['pekerjaan_sekarang']?></h5>
                      <h5 class="grey-text ">Kesan : <?php echo $ambil['kesan']?></h5>
                    </div>   
                  </div>
                </div>
              </div>
    ...
    <section id="contact" class="contact grey lighten-4 scrollspy">
      <div class="container">
        ...
        <div class="row">
          <div class="col m5 s12" data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="90" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
          ...
          <div class="col m6 s12" data-aos="zoom-in-up" data-aos-offset="200" data-aos-delay="400" data-aos-easing="ease" data-aos-mirror="true" data-aos-once="false">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var elems = document.querySelectorAll('.slider1');
        var instances = M.Slider.init(elems, {'height' : 650, 'indicators':true });
      });
	...
	<?php	if(isset($_COOKIE['pesan'])=="sukses") {?>
	<script>
