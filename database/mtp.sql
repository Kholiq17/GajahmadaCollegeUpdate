...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jul 2020 pada 13.22
...
INSERT INTO `alumni` (`id`, `foto`, `nama`, `alamat`, `angkatan`, `jurusan`, `pekerjaan_sekarang`, `kesan`) VALUES
(36, '181-profil.png', 'Itmam', 'Semarang', '16', 'Teknik Informatika', 'Mahasiswa  ', 'Sangat Bermanfaat'),
(37, '39-profil.png', 'Cermin', 'asdasd', '12', 'Teknik Informatika', 'Mahasiswa', 'Sangat Bermanfaat'),
(38, '515-profil.png', 'Haha', 'haha', 'ahha', 'ahah', 'ahah', 'ahaha'),
(39, '587-profil.png', 'Itmam', 'asdasd', '12', 'Teknik Informatika', 'asdasd', 'Sangat Bermanfaat');
...
INSERT INTO `servis` (`id`, `foto`, `info`) VALUES
(3, '784-1.png', 'We did most of the heavy lifting for you to provide a default stylings that incorporate our custom components.'),
(4, '4-1.png', 'By utilizing elements and principles of Material Design, we were able to create a framework that focuses on User Experience.\r\n'),
(5, '376-1.png', 'We have provided detailed documentation as well as specific code examples to help new users get started.');
